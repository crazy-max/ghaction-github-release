...
1. [Fork](https://github.com/crazy-max/ghaction-github-release/fork) and clone the repository
...
7. Push to your fork and [submit a pull request](https://github.com/crazy-max/ghaction-github-release/compare)
