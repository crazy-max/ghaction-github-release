...
describe('util', () => {
  describe('uploadUrl', () => {
    it('strips template', () => {
      expect(uploadUrl('https://uploads.github.com/repos/octocat/Hello-World/releases/1/assets{?name,label}')).toEqual('https://uploads.github.com/repos/octocat/Hello-World/releases/1/assets');
    });
  });
  ...
  describe('paths', () => {
    it('resolves files given a set of paths', async () => {
      expect(paths(['__tests__/fixtures/data/**/*', '__tests__/fixtures/data/does/not/exist/*'])).toStrictEqual(['__tests__/fixtures/data/foo/bar.txt']);
    });
  });

  describe('unmatchedPatterns', () => {
    it("returns the patterns that don't match any files", async () => {
      expect(unmatchedPatterns(['__tests__/fixtures/data/**/*', '__tests__/fixtures/data/does/not/exist/*'])).toStrictEqual(['__tests__/fixtures/data/does/not/exist/*']);
    });
  });
});
